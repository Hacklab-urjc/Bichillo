{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "21e595cf-a6e0-4af0-a088-90903e2f74ad",
          "type": "basic.output",
          "data": {
            "name": "DEBUG",
            "range": "[7:0]",
        ...
        {
          "id": "0314dc3b-a850-432c-9aa1-ad849e1bbca5",
          "type": "basic.output",
          "data": {
            "name": "LEDS",
            "range": "[7:0]",
        ...
        {
          "id": "11bb3e87-59a5-4411-96a2-09fac1300492",
          "type": "basic.input",
          "data": {
            "name": "RESET",
            "pins": [
        ...
        {
          "id": "d6556394-982f-436e-a59d-7b0ea235509a",
          "type": "basic.output",
          "data": {
            "name": "ERR",
            "pins": [
        ...
        {
          "id": "5b016e0f-e1c6-4ea0-99d1-842c0812374b",
          "type": "basic.output",
          "data": {
            "name": "NOP",
            "pins": [
        ...
        {
          "id": "7c681e0d-3a13-432f-b6ac-c73aa093ef9a",
          "type": "basic.input",
          "data": {
            "name": "NEXT",
            "pins": [
        ...
        {
          "id": "ae0b4219-3f47-48bb-996d-368d0f6948fa",
          "type": "basic.code",
          "data": {
        ...
        {
          "id": "06908edc-bcc8-4d43-af2c-189fc0240a34",
          "type": "basic.info",
          "data": {
            "info": "<B>Contador de programa</B>",
            "readonly": true
          },
          "position": {
            "x": 192,
        ...
        {
          "id": "859efcc3-bb9c-46fb-8db1-7e0bca904658",
          "type": "basic.code",
          "data": {
            "code": "reg [7:0] pc = 0;\n\nalways @(posedge clk)\n   if (rst)\n     pc <= 8'h00;\n   else\n     if (inc)\n       pc <= pc + 1;",
            "params": [],
        ...
        {
          "id": "dfc14e95-c7b2-4d30-a3fa-4b40c8f94cee",
        ...
        {
          "id": "2a737171-938f-430e-b1a6-b3223258dc7d",
          "type": "1818fc8daaee5f849bcd11ad3489c3450c1ee22e",
          "position": {
            "x": -24,
            "y": 296
          },
        ...
        {
          "id": "b89d81ff-cc4a-41d0-995b-bd5265ae90db",
          "type": "basic.info",
          "data": {
            "info": "<B>Inicializacion</B>",
            "readonly": true
          },
          "position": {
            "x": -48,
        ...
        {
          "id": "5d6f3d00-9649-48f3-bdc8-2559fcc391a8",
        ...
        {
          "id": "bd6156a5-c7c7-44f9-90bb-01e2452c5eb7",
          "type": "basic.code",
          "data": {
            "code": "//-- Codigo operacion de NOP\nlocalparam NOP = 4'b0000;\n\n//-- Unidad de control\nlocalparam INIT = 0;\nlocalparam FETCH = 1;\nlocalparam EXEC = 2;\n\n//-- Estado del automata\nreg [2:0] state= INIT;\nreg [2:0] next_state;\n\n//-- Salidas\nreg pc_inc = 0;  //-- Incrementar el PC\nreg op_err = 0;  //-- Opcode incorrecto\nreg nop = 0;     //-- Instrucción NOP\n\n//-- Transiciones de estados\nwire clk_tic;\nalways @(posedge clk)\n    if (rst)\n      state <= INIT;\n    else\n      state <= next_state;\n      \n//-- Generacion de microordenes\n//-- y siguientes estados\nalways @(*) begin\n\n  //-- Valores por defecto:\n  \n  //-- Permanecer en mismo estado\n  next_state = state;\n  pc_inc = 0;\n  op_err = 0;\n  nop = 0;\n  \ncase (state)\n    //-- Estado inicial y de reposo\n    INIT: begin\n        next_state = FETCH;\n    end\n\n    //-- Ciclo de captura\n    FETCH: begin\n      next_state = EXEC;\n    end\n\n    //-- Ciclo de ejecucion\n    EXEC: begin\n      if (next) begin\n        next_state = FETCH;\n        pc_inc = 1;\n      end\n      \n      case (opcode)\n\n        //-- Instruccion NOP\n        NOP: begin\n          nop = 1;  \n        end\n\n        default: begin\n          next_state = EXEC;\n          op_err = 1;\n        end\n\n      endcase\n    end\n      \n    default:\n      next_state = INIT;\n      \n  endcase\n\nend\n\n  \n",
            "params": [],
            "ports": {
              "in": [
                {
        ...
        {
          "id": "9028147d-c9cc-4ec6-b4ca-02157a94385c",
        ...
        {
          "id": "4013c7ea-6ab1-41b2-98fb-93e4e3ef5ac2",
          "type": "basic.info",
          "data": {
            "info": "Bichillo 1\n----------\n\nEs Bichillo 0 con una mini-unidad de control que le permite \"ejecutar\" la\ninstrucción NOP que  enciende un LED, para depurar\n\nEl resto de códigos de operacion no están implementados, y al detectar uno se\nenciende el LED asociado a ERR, para indicar que es una instruccion no valida\n\nLa unidad de control se queda esperando a que apretemos el pulsador para ejecutar\nla siguiente instrucción. Genera la microórden pc_inc para incrementar el PC",
            "readonly": false
          },
          "position": {
            "x": -280,
        ...
        {
          "id": "1c15e480-25c3-44f8-b3f2-d0324a6f0b97",
          "type": "basic.info",
          "data": {
            "info": "<B>Unidad de control</B>",
            "readonly": true
          },
          "position": {
            "x": 1320,
        ...
        {
          "id": "9fe6ec6c-ac65-4eb7-9639-8b87e84e0989",
          "type": "basic.info",
          "data": {
            "info": "Pulsador de siguiente instrucción",
            "readonly": true
          },
          "position": {
            "x": 792,
        ...
        {
          "id": "c8e23abe-ab33-49e3-a3b7-2e0c8096c5db",
          "type": "basic.info",
          "data": {
            "info": "Código de operación\nincorrecto",
            "readonly": true
          },
          "position": {
            "x": 1680,
        ...
        {
          "id": "8c1d6ee1-195e-4e88-88b6-4a9e9ccf213a",
          "type": "basic.info",
          "data": {
            "info": "Instrucción NOP",
            "readonly": true
          },
          "position": {
            "x": 1704,
      ...
      "wires": [
        {
          "source": {
            "block": "ae0b4219-3f47-48bb-996d-368d0f6948fa",
            "port": "data"
          },
          "target": {
            "block": "0314dc3b-a850-432c-9aa1-ad849e1bbca5",
            "port": "in"
          },
          "size": 8
        },
        ...
        {
          "source": {
            "block": "dfc14e95-c7b2-4d30-a3fa-4b40c8f94cee",
            "port": "3d584b0a-29eb-47af-8c43-c0822282ef05"
          },
          "target": {
            "block": "2a737171-938f-430e-b1a6-b3223258dc7d",
        ...
        {
          "source": {
            "block": "11bb3e87-59a5-4411-96a2-09fac1300492",
            "port": "out"
          },
          "target": {
            "block": "2a737171-938f-430e-b1a6-b3223258dc7d",
        ...
        {
          "source": {
            "block": "7c681e0d-3a13-432f-b6ac-c73aa093ef9a",
            "port": "out"
          },
          "target": {
        ...
        {
          "source": {
            "block": "9028147d-c9cc-4ec6-b4ca-02157a94385c",
            "port": "264e6021-ea4a-4b71-90fc-033e2b6440ea"
          },
          "target": {
            "block": "bd6156a5-c7c7-44f9-90bb-01e2452c5eb7",
            "port": "opcode"
          },
          "size": 4
        },
        ...
        },
        {
          ...
          "target": {
            "block": "21e595cf-a6e0-4af0-a088-90903e2f74ad",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "5b016e0f-e1c6-4ea0-99d1-842c0812374b",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "d6556394-982f-436e-a59d-7b0ea235509a",
            "port": "in"
          }
        },
        {
  ...
  "dependencies": {
    ...
    "1818fc8daaee5f849bcd11ad3489c3450c1ee22e": {
      "package": {
        "name": "Biestable-D-rst-1",
        "version": "0.1",
        "description": "Biestable D con rst inicializado a 1",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "e6dd6153-b382-43a7-9e4c-e7ac9d6bb2f4",
              "type": "338be03999a6cf941fafc5ffd3b0ff80ec33c2eb",
              "position": {
                "x": 336,
                "y": 216
              },
          ...
          "wires": [
            {
              "source": {
                "block": "e6dd6153-b382-43a7-9e4c-e7ac9d6bb2f4",
    ...
    "338be03999a6cf941fafc5ffd3b0ff80ec33c2eb": {
      "package": {
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "ef4df690-6886-4f01-a2d5-0f25d5bb23d1",
              "type": "3fcbeca6e8d94cb7e33d00bece659113a6e831f0",
              "position": {
                "x": 72,
                "y": 64
              },
            ...
            {
              "id": "05b739c9-ced8-481c-9809-5b30ada0ff79",
            ...
            {
              "id": "a11a6e68-23df-4b8a-a0cb-dae083f18c37",
          ...
          "wires": [
            {
              ...
              "target": {
                "block": "ef4df690-6886-4f01-a2d5-0f25d5bb23d1",
            ...
            {
              "source": {
                "block": "05b739c9-ced8-481c-9809-5b30ada0ff79",
            ...
            {
              "source": {
                "block": "a11a6e68-23df-4b8a-a0cb-dae083f18c37",
    ...
    "3fcbeca6e8d94cb7e33d00bece659113a6e831f0": {
      "package": {
        "name": "Const-1bit",
        "version": "0.1",
