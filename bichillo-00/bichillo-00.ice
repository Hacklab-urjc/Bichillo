  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "8b13ba8f-1a7f-47f2-8213-c4a2a50caec0",
          "type": "basic.info",
          "data": {
            "info": "Bichillo 0\n----------\n\nTiene una memoria ROM de 256 x 8. Solo las primeras direcciones contiene datos, \nel resto están a 0. Su salida está conectada directamente a los 8 LEDs\nde la Icezum Alhambra, para poder ver el contenido de la dirección actual\n\nTiene un contador de programa (PC) de 8 bits que direcciona la memoria\nCuando se aprieta el pulsador 1 se incrementa el PC. Con el pulsador 2 se\nhace un RESET y el PC se poner de nuevo a 0",
            "readonly": false
          },
          "position": {
            "x": -224,
