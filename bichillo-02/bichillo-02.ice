  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "2d8ebd43-8ac2-45b6-af65-a6846a36a1dc",
          "type": "basic.info",
          "data": {
            "info": "Bichillo 2\n----------\n\nInstrucciones: NOP, HALT\n\nEs Bichillo 1 con la instrucción HALT. Cuando se ejecuta HALT se activa una salida\npara indicar que el procesador se ha parado. Ya no se ejecutan más instrucciones. Para\narrancarlo hay que apretar el pulsador de reset (SW2)\n\nAl ejecutar cualquier codigo de operacion diferente de NOP o HALT se activa la \nsalida de error",
            "readonly": false
          },
          "position": {
            "x": -176,
